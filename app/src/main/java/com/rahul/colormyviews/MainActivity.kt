package com.rahul.colormyviews
...
class MainActivity : AppCompatActivity() {
    ...
    fun makeColored(view: View) {
        when (view.id) {
            ...
            R.id.box_two_text -> view.setBackgroundResource(android.R.color.holo_red_light)
            ...
            else -> view.setBackgroundResource(android.R.color.holo_blue_bright)
        }
    }
}
